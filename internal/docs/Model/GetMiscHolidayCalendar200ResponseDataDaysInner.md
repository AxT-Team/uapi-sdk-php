...
**is_holiday** | **bool** | 当天是否存在节日/节气/法定事件。 | [optional]
**legal_holiday_name** | **string** | 法定节假日名称，无则为空。 | [optional]
**legal_holiday_type** | **string** | 法定假日类型：rest 或 workday_adjust。 | [optional]
**solar_festival** | **string** | 公历节日名称，无则为空。 | [optional]
**lunar_festival** | **string** | 农历节日名称，无则为空。 | [optional]
**solar_term** | **string** | 节气名称，无则为空。 | [optional]
