...
**alerts** | [**\OpenAPI\Client\Model\GetMiscWeather200ResponseAlertsInner[]**](GetMiscWeather200ResponseAlertsInner.md) | 官方气象预警列表（存在有效预警时返回） | [optional]
...
**weather_icon** | **string** | 天气图标代码。请从[天气图标代码表](#enum-list)中查看所有可能的值。 | [optional]
