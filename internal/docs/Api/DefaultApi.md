...
$post_search_aggregate_request = new \OpenAPI\Client\Model\PostSearchAggregateRequest(); // \OpenAPI\Client\Model\PostSearchAggregateRequest | 包含搜索参数的JSON对象
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_search_aggregate_request** | [**\OpenAPI\Client\Model\PostSearchAggregateRequest**](../Model/PostSearchAggregateRequest.md)| 包含搜索参数的JSON对象 | |
...
$post_sensitive_word_analyze_request = new \OpenAPI\Client\Model\PostSensitiveWordAnalyzeRequest(); // \OpenAPI\Client\Model\PostSensitiveWordAnalyzeRequest | 包含待检测文本 'keywords' 的JSON对象
...
| Name | Type | Description  | Notes |
| ------------- | ------------- | ------------- | ------------- |
| **post_sensitive_word_analyze_request** | [**\OpenAPI\Client\Model\PostSensitiveWordAnalyzeRequest**](../Model/PostSensitiveWordAnalyzeRequest.md)| 包含待检测文本 &#39;keywords&#39; 的JSON对象 | |
