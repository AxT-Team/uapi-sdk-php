...
/**
 * GetSocialBilibiliVideoinfo200ResponsePagesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetSocialBilibiliVideoinfo200ResponsePagesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_social_bilibili_videoinfo_200_response_pages_inner';
    ...
    */
     ...
     * Sets cid
     *
     * @param float|null $cid 分P的唯一标识CID，用于获取弹幕等。
     *
     * @return self
     */
     ...
     * Sets duration
     *
     * @param float|null $duration 该分P的持续时间，单位为秒。
     *
     * @return self
     */
     ...
     * Sets page
     *
     * @param float|null $page 分P的序号，从1开始。
     *
     * @return self
     */
     ...
     * Sets part
     *
     * @param string|null $part 分P的标题。对于单P视频，通常是视频主标题。
     *
     * @return self
     */
