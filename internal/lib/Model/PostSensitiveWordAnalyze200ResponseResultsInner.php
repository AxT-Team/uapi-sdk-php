...
/**
 * PostSensitiveWordAnalyze200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostSensitiveWordAnalyze200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_sensitive_word_analyze_200_response_results_inner';
    ...
    */
    ...
    public function setConfidence($confidence)
    {
        ...
        if (($confidence > 1.0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling PostSensitiveWordAnalyze200ResponseResultsInner., must be smaller than or equal to 1.0.');
        }
        if (($confidence < 0.0)) {
            throw new \InvalidArgumentException('invalid value for $confidence when calling PostSensitiveWordAnalyze200ResponseResultsInner., must be bigger than or equal to 0.0.');
        }
