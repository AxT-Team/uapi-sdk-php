...
class GetMiscWeather200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'alerts' => '\OpenAPI\Client\Model\GetMiscWeather200ResponseAlertsInner[]',
        'aqi' => 'float',
        'aqi_category' => 'string',
        'aqi_level' => 'float',
        'aqi_primary' => 'string',
    ...
    */
     ...
     * Gets alerts
     *
     * @return \OpenAPI\Client\Model\GetMiscWeather200ResponseAlertsInner[]|null
     */
     ...
     * Sets alerts
     *
     * @param \OpenAPI\Client\Model\GetMiscWeather200ResponseAlertsInner[]|null $alerts 官方气象预警列表（存在有效预警时返回）
     *
     * @return self
     */
