...
/**
 * GetMiscHotboard200ResponseOneOf Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetMiscHotboard200ResponseOneOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_misc_hotboard_200_response_oneOf';
    ...
    */
     ...
     * Sets update_time
     *
     * @param string|null $update_time 热榜更新时间。时光机模式下对应返回快照的更新时间。
     *
     * @return self
     */
