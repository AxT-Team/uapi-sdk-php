...
/**
 * GetStatusUsage200ResponseAnyOf Class Doc Comment
 *
 * @category Class
 ...
 */
class GetStatusUsage200ResponseAnyOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'get_status_usage_200_response_anyOf';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unaggregated', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['unaggregated'];
    }
     ...
     * @return self
     */
    public function setUnaggregated($unaggregated)
    {
        if (is_null($unaggregated)) {
            throw new \InvalidArgumentException('non-nullable unaggregated cannot be null');
        }
        $this->container['unaggregated'] = $unaggregated;
